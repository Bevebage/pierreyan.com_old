const userData = {
  ...
  experience: [
    {
      ...
      company: "DeepMap AI",
      year: "2021",
      companyLink: "https://www.nvidia.com/en-us/self-driving-cars/hd-mapping/",
      desc: "Developed a three dimensional map profiling tool as a software intern. The startup got obtained by Nvidia. I didn't have any internal stock :(."
    },
    {
      title: "College",
    ...
    {
      title: "High School",
      company: "Haddonfield Memorial High School",
      year: "2020",
  ...
  socialLinks: {
    ...
    linkedin: "https://www.linkedin.com/in/pierre-yan-5625a21b6/",
